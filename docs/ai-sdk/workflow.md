...
This tutorial demonstrates how to create a workflow visualization using AI Elements. The example includes custom nodes with headers, content, and footers, along with animated and temporary edge types.

### Features

- **Custom Node Components**: Structured layouts using compound components
- **Node Toolbars**: Contextual actions attached to nodes
- **Handle Configuration**: Control source and target connections
- **Multiple Edge Types**: Animated and temporary edge types
- **Custom Connection Lines**: Styled bezier curves
- **Interactive Controls**: Zoom and fit view functionality
- **Custom UI Panels**: Position custom UI elements anywhere on the canvas
...
- [v0 clone](https://ai-sdk.dev/elements/examples/v0) - An example of how to use the AI Elements to build a v0 clone.
- [Chain of Thought](https://ai-sdk.dev/elements/components/chain-of-thought) - A collapsible component that visualizes AI reasoning steps with support for search results, images, and step-by-step progress indicators.
